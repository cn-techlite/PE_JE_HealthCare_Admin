...
class ViewUserAssignedServiceUser extends ConsumerStatefulWidget {
  const ViewUserAssignedServiceUser({
    super.key,
    required this.id,
  });
  final String id;
  ...
  void initState() {
    ...
    data = homeProviders.allServiceUsers.where((element) {
      return element.sunday!.morningVisitId == widget.id ||
          ...
          element.monday!.nightVisitId == widget.id ||
          element.tuesday!.morningVisitId == widget.id ||
          element.tuesday!.nightVisitId == widget.id ||
          element.wednesday!.morningVisitId == widget.id ||
          element.wednesday!.nightVisitId == widget.id ||
          element.thursday!.morningVisitId == widget.id ||
          element.thursday!.nightVisitId == widget.id ||
          element.friday!.morningVisitId == widget.id ||
          element.friday!.nightVisitId == widget.id ||
          element.saturday!.morningVisitId == widget.id ||
          element.saturday!.nightVisitId == widget.id;
    }).toList();
    super.initState();
  }
